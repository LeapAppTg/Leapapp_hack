...
import { CheckmarkIcon, IconBox, IconColor, IconSize, QuestionCircleIcon, SecurityLockIcon, UserProfileIcon } from "@icons";
...
export const QuestItem: FC<QuestItemProps> = ({
    uuid, name, rewardPoints, completionStatus
}) => {
...
export const HiddenQuestItem: FC = () => {
    return (
        <div className={FlexGapColumn4.withExtraClasses(styles.hidden)}>
            <div className={styles.status_icon}>
